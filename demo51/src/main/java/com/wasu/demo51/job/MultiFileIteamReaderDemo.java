...
/**
 * @ClassName:MultiFileIteamReaderDemo
 * @Description: 多文件读取
 * @Author: Syl
...
public class MultiFileIteamReaderDemo {
    ...
    private ItemReader<? extends TestData> multiFileItemReader() {
    ...
    private ResourceAwareItemReaderItemStream<? extends TestData> fileItemReader() {
        ...
        mapper.setLineTokenizer(tokenizer); // 设置映射方式
